...
public class DAOSupplier extends DBConnection {
    ...
    public int insertSupplier(Suppliers other) {
        ...
        String sql = "INSERT INTO [dbo].[Suppliers]\n"
                ...
                + "'" + other.getPostalCode() + "' ,'" + other.getCountry() + "' ,'" + other.getPhone() + "' ,'" + other.getFax() + "' ,'" + other.getHomePage() + "')";
        try {
    ...
    public Vector<Suppliers> getSuppliers(String sql) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Suppliers newsupplier = new Suppliers(SupplierID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax, HomePage);
